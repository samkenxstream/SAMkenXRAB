...
describe('behavior of Java Dependency process', () => {
  it('should return false in checkPR if incoming PR does not match classRules', async () => {
    ...
    const rule = new JavaDependency(octokit);
  ...
  it('should return true in checkPR if incoming PR does match classRules - pom.xml', async () => {
    const pullRequest: PullRequest = {
      author: 'renovate-bot',
      title: 'fix(deps): update dependency com.google.cloud:google-cloud-datacatalog to v16',
      fileCount: 3,
      changedFiles: [
        {
          sha: '1349c83bf3c20b102da7ce85ebd384e0822354f3',
  ...
  it('should return true in checkPR if incoming PR does match classRules - build.gradle - grpc version', async () => {
    const pullRequest: PullRequest = {
      author: 'renovate-bot',
      title: 'chore(deps): update dependency io.grpc:protoc-gen-grpc-java to v1.40.1',
      fileCount: 3,
      changedFiles: [
        {
          sha: '1349c83bf3c20b102da7ce85ebd384e0822354f3',
  ...
  it('should return true in checkPR if incoming PR does match classRules - build.gradle - classpath', async () => {
    const pullRequest: PullRequest = {
      author: 'renovate-bot',
      title: 'chore(deps): update dependency com.google.cloud.tools:endpoints-framework-gradle-plugin to v1.0.3',
      fileCount: 3,
      changedFiles: [
        {
          sha: '1349c83bf3c20b102da7ce85ebd384e0822354f3',
  ...
  it('should return true in checkPR if incoming PR does match classRules - build.gradle - invoker', async () => {
    const pullRequest: PullRequest = {
      author: 'renovate-bot',
      title: 'chore(deps): update dependency com.google.cloud.functions.invoker:java-function-invoker to v1.0.2',
      fileCount: 3,
      changedFiles: [
        {
          sha: '1349c83bf3c20b102da7ce85ebd384e0822354f3',
  ...
  it('should return true in checkPR if incoming PR does match classRules - pom.xml - apiary update', async () => {
    const pullRequest: PullRequest = {
      author: 'renovate-bot',
      title: 'chore(deps): update dependency com.google.apis:google-api-services-cloudiot to v1-rev20210816-1.32.1',
      fileCount: 3,
      changedFiles: [
        {
          sha: '1349c83bf3c20b102da7ce85ebd384e0822354f3',
